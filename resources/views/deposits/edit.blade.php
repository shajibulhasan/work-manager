    ...
    <div class="col-md-8 offset-md-2">
        <div class="card">
            <div class="card-header bg-success text-white">
                <h5><i class="fas fa-edit"></i> Edit Deposit</h5>
            </div>
            <div class="card-body">
                <form action="{{ route('deposits.update', $deposit) }}" method="POST">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="date" 
                                   ...
                                   value="{{ old('deposit_date', $deposit->deposit_date->format('Y-m-d')) }}" required>
                            @error('deposit_date')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" 
                                   ...
                                   value="{{ old('depositor_name', $deposit->depositor_name) }}" required>
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" 
                                   ...
                                   value="{{ old('received_by', $deposit->received_by) }}" required>
                            @error('received_by')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control @error('purpose') is-invalid @enderror" 
                                  id="purpose" name="purpose" rows="3">{{ old('purpose', $deposit->purpose) }}</textarea>
                        @error('purpose')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
